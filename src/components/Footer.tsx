        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex space-x-2 md:space-x-4">
              ...
              <Button variant="ghost" className="hover:bg-primary-foreground/10 h-8 w-auto md:h-12 px-2 md:px-3 gap-1 md:gap-2"  
                    onClick={() => window.open("https://www.google.com/search?q=shivienergy", '_blank')}>
